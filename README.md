...
FieldDetailSourceCharlotte Mecklenburg Schools — Sample Data #9 (synthetic)ScopeELA assessments, grades 3–8, across 149 schoolsFormatExcel (.xlsx), exported to CSV for SQL importRows38,987Key ColumnsSchool_Student_ID, AchLevel_First, AchLevel_Final, TestName, GradeLevel, LEPCategory, RaceDescription, EC, School, Teacher, Achlevel, SchoolPerformanceArea, AnnualTarget26_27, Actual23_24, Actual24_25, Actual25_26, RankingTier
...
Which schools and grade levels are furthest from their 2026/27 performance targets?
Are there meaningful achievement gaps across student subgroups (race, LEP status, EC status)?
Which schools show the strongest and weakest growth trends from 2023/24 to 2025/26?
How does RankingTier correlate with actual performance outcomes across SchoolPerformanceArea?
